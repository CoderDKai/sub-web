...
export const CONSTANTS = {
  ...
  DEFAULT_REMOTE_CONFIG: process.env.VUE_APP_DEFAULT_REMOTE_CONFIG,
  DOC_ADVANCED: process.env.VUE_APP_SUBCONVERTER_DOC_ADVANCED,
  BACKEND_RELEASE: process.env.VUE_APP_BACKEND_RELEASE,
  DEFAULT_BACKEND: process.env.VUE_APP_SUBCONVERTER_DEFAULT_BACKEND
    ? process.env.VUE_APP_SUBCONVERTER_DEFAULT_BACKEND + '/sub?'
    : '',
  DEFAULT_BACKEND_OPTION: process.env.VUE_APP_DEFAULT_BACKEND_OPTION
    || (process.env.VUE_APP_SUBCONVERTER_DEFAULT_BACKEND
      ? process.env.VUE_APP_SUBCONVERTER_DEFAULT_BACKEND + '/sub?'
      : ''),
